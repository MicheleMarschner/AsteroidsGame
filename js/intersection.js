...
external source code for handling collision with the Separating Axis 
Theorem (*also for convex polygons*)

contains additional functions for when collision is detected 
